...
Var Majver, Minver, Rev, BuildNum:string;
    sProgName:string;
    Info: TVersionInfo;
begin
...
begin
   //OpenURL('https://sourceforge.net/projects/caissystem/files/MV2_Studio_for_Windows%28Lazarus_project%29/');
